# **Cambridge IELTS 16 - Test 4 - Reading Passage 2**
...
| **hunch over**                     | bend or stoop forward while focusing intensely on something                              | ...older kids don't read at all, but **hunch over** video games.                                                                            |
...
| **superior**                       | excellent, high-class, top-quality, exclusive                                            | ...students who read on print were **superior** in their comprehension...                                                                   |
| **sequence**                       | order, arrange, structure                                                                | ...particularly in their ability to **sequence** detail and reconstruct the plot...                                                         |
| **chronological**                  | according to the order of time                                                           | ...and reconstruct the plot in **chronological** order.                                                                                     |
| **norm**                           | standard, rule, custom                                                                   | ...the 'new **norm**' in reading is skimming, involving word-spotting and browsing...                                                       |
| **browsing**                       | surf, look, glance                                                                       | ...involving word-spotting and **browsing** through the text.                                                                               |
| **sample**                         | test, try, taste, experiment                                                             | Many readers now use a pattern... in which they **sample** the first line...                                                                |
